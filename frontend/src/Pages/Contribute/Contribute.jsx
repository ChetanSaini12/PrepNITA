      ...
      <div className="flex justify-evenly items-center gap-20 flex-wrap w-full my-10">
        <div className="bg-slate-800 shadow-xl rounded-lg w-1/3 h-full">
          ...
          <div className="flex flex-col items-center text-center p-6">
            <h2 className="text-2xl font-bold mb-2">Share a Company Drive Experience</h2>
            <p className="mb-4">
              Tell us about any company drive you had.
            </p>
            <div className="mt-4">
        ...
        <div className="bg-slate-800 shadow-xl rounded-lg w-1/3 h-full">
          ...
          <div className="flex flex-col items-center text-center p-6">
            <h2 className="text-2xl font-bold mb-2">Create a Question</h2>
            <p className="mb-4">
